  ...
  return (
    <section className="flex justify-center items-center relative">
      <img
        ...
        alt=""
      />
      <div className="h-[100px] w-[180px] bg-slate-50 rounded-lg flex flex-col md:gap-6 absolute bottom-2 left-16 justify-center sm:pl-8  pl-4 gap-3 sm:w-[450px] sm:h-[200px]">
