...
const SinglePost = () => {
  return (
    ...
    <div className='md:w-[600px] w-[300px] flex flex-col md:gap-6'>
        <h3 className='font-bold md:text-2xl'>The Impact of Technology on the Workplace: <br />How Technology is Changing</h3>
        ...
        <h5 className='font-bold'>Research Your Destination</h5>
...
<h5 className='font-bold'>Plan Your Itinerary</h5>
<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut aperiam obcaecati officiis eligendi ab aliquam, alias quaerat nisi. Earum facilis soluta ea vero quas laboriosam praesentium minus saepe beatae doloribus?</p>
    </div>
    </section>
  )
}
