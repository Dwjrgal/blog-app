...
const Contact = () => {
  return (
    ...
    <section className='md:flex md:flex-col md:px-40'>
        ...
        <p className='md:w-[643px]  w-[300px] h-[100px]md:h-[143px] mt-2 px-8'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestias nesciunt similique incidunt modi velit quo optio, aliquam magni ipsa, quam reiciendis non deserunt ullam eius dicta, minus soluta vel rerum!</p>
        <div className=' flex flex-col md:flex md:gap-16 w-[300px] px-8 gap-4'>
        ...
        <div className='md:h-[400px] md:w-[643px] bg-[#F6F6F7] mt-10 flex flex-col gap-8 pl-10 py-6 rounded-md h-[250px] w-[400px]'>
            <h5 className='font-bold'>Leave a Message</h5>
            <div className='flex flex-col h-[200px] w-[300px] md:h-[300px] gap-4 md:w-[420px]'>
            <div className='md:flex md:gap-6 flex flex-col gap-4'>
